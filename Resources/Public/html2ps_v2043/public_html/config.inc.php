...
// dwildt, 110919+
$tmp_path_to_fonts = HTML2PS_DIR."fonts/";
$tmp_path_to_fonts = str_replace('pdfcontroller', 'pdfcontroller_fonts', $tmp_path_to_fonts);
define('TTF_FONTS_REPOSITORY', $tmp_path_to_fonts);
// dwildt, 110919+
