 ...
 *
 *
 *   47: class tx_pdfcontroller_pi2_be_wizicon
 *   70:     function getLL()
 *
 * TOTAL FUNCTIONS: 1
 ...
 *
 */
class tx_pdfcontroller_pi2_be_wizicon
{
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pdfcontroller/pi2/class.tx_pdfcontroller_pi2_be_wizicon.php'])
{
  include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pdfcontroller/pi2/class.tx_pdfcontroller_pi2_be_wizicon.php']);
}
